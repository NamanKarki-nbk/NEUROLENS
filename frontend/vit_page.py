...
API_URL = "http://127.0.0.1:8000/analyze-and-explain/VIT"


def show():
    st.title("VIT ANALYSIS")
    st.markdown("---")

    st.subheader(
        "Analyze the image using Vision Transformer and get explanation through RAG system"
    )
    st.markdown("---")
